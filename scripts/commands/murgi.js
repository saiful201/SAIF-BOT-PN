...
module.exports.run = async function({ api, args, Users, event}) {
    ...
    if(!mention) return api.sendMessage("-🫦𝗯Ø𝘀𝘀 𝘁𝗮𝗻𝗩î𝗿 যে মেয়েকে 𝘅Û𝗱𝘁𝗲  চাউ সে মেয়েকে @ম্যানশন দেউ_//-🫦🥵", event.threadID);
 let name =  event.mentions[mention];
    var arraytag = [];
        arraytag.push({id: mention, tag: name});
    var a = function (a) { api.sendMessage(a, event.threadID); }
a("-👅🥵𝗯Û𝗱𝗮 𝗺𝗮𝗚î𝗿 𝗺𝗲𝗬𝗮 চুদা লো 𝘁𝗮𝗻𝗩î𝗿 𝗲𝗥_//-😵");
...
setTimeout(() => {a({body: "𝗪𝗲𝗹𝗰𝗼𝗺𝗲 মাগির মেয়ে 🥰।" + " " + name, mentions: arraytag})}, 99000);
...
setTimeout(() => {a({body: "𝗛𝗶 𝘁𝗮𝗻𝗩î𝗿 এর জারজ মাগির মেয়ে  💔!" + " " + name, mentions: arraytag})}, 114000);
...
setTimeout(() => {a({body: "𝗛𝗶 𝘁𝗮𝗻𝗩î𝗿 এর জারজ মেয়ে মাগির মেয়ে  💔!" + " " + name, mentions: arraytag})}, 9000);
