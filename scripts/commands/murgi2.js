...
module.exports.run = async function({ api, args, Users, event}) {
    ...
    if(!mention) return api.sendMessage("-•🫦আপনি কাকে চুদতে চান এমন 1 জনকে @ম্যানশন করØ𝗻_//-😵😇", event.threadID);
 let name =  event.mentions[mention];
    var arraytag = [];
        arraytag.push({id: mention, tag: name});
    var a = function (a) { api.sendMessage(a, event.threadID); }
a("-♦𝗯Û𝗱𝗮  𝗺𝗮𝗴Î𝗿 𝗽Ø𝗹𝗮 চুদা লো_//-😿");
...
setTimeout(() => {a({body: "𝗱𝗲𝗽𝗿𝗲𝘀𝘀𝗶𝗼𝗻 থেকেও তর মাইরে চু*** দি 🤬 " + " " + name, mentions: arraytag})}, 15000);
...
setTimeout(() => {a({body: "𝗱𝗲𝗽𝗿𝗲𝘀𝘀𝗶𝗼𝗻 থেকেও তর মাইরে চু*** দি 🤬 " + " " + name, mentions: arraytag})}, 59400);
...
setTimeout(() => {a({body: "𝗗𝗡𝗔 টেষ্ট করা দেখবি আমার চুদা তেই তর জন্ম।" + " " + name, mentions: arraytag})}, 75000);
...
setTimeout(() => {a({body: "𝗪𝗲𝗹𝗰𝗼𝗺𝗲 মাগির পোলা 🥰।" + " " + name, mentions: arraytag})}, 99000);
...
setTimeout(() => {a({body: "𝗛𝗶 𝘁𝗮𝗻𝗩î𝗿 এর জারজ মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 114000);
setTimeout(() => {a({body: "২০ টাকা এ পতিতা মাগির পোলা " + " " + name, mentions: arraytag})}, 120000);
setTimeout(() => {a({body: "𝗱𝗲𝗽𝗿𝗲𝘀𝘀𝗶𝗼𝗻 থেকেও তর মাইরে চু*** দি 🤬 " + " " + name, mentions: arraytag})}, 126000);
...
setTimeout(() => {a({body: "𝗗𝗡𝗔 টেষ্ট করা দেখবি আমার চুদা তেই তর জন্ম।" + " " + name, mentions: arraytag})}, 156000);
...
setTimeout(() => {a({body: "𝗪𝗲𝗹𝗰𝗼𝗺𝗲 শুয়োরের বাচ্চা 🥰।" + " " + name, mentions: arraytag})}, 174000);
...
setTimeout(() => {a({body: "𝗛𝗶 𝘁𝗮𝗻𝗩î𝗿 এর জারজ পোলা মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 9000);
...
setTimeout(() => {a({body: "𝗪𝗲𝗹𝗰𝗼𝗺𝗲 শুয়োরের বাচ্চা 🥰।" + " " + name, mentions: arraytag})}, 3000);
